...
public class GameTests {
    ...
    public void playerCannotMakeAnIllegalGuess(int a, int b) {
        // When
        game = new Game();
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            game.processGuess(new Coordinates(a, b), playerService);
        });
    }
    ...
    public void guessingTheSameFieldTwiceShowsMessage() {
        // When
        game.processGuess(new Coordinates(2, 2), playerService);
        game.processGuess(new Coordinates(2, 2), playerService);
        // Then
